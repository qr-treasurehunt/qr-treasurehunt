...
const QRScannerWithSnapshot = forwardRef(({ onQRCodeScanned, width = 320, height = 240, style = {} }, ref) => {
                ...
                if (isComponentMounted && videoRef.current && !videoRef.current.paused) {
                  const scan = () => {
                    ...
                    if (videoRef.current && canvasRef.current) {
                      ...
                      if (code && code.data && onQRCodeScanned) {
...
QRScannerWithSnapshot.displayName = 'QRScannerWithSnapshot';

export default QRScannerWithSnapshot;
